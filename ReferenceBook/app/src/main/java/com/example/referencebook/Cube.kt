...
class Cube {
    ...
    private val colors = floatArrayOf(
        1.0f, 0.0f, 0.0f, 0.5f,  // 0: Красный
        0.0f, 1.0f, 0.0f, 0.5f,  // 1: Зеленый
        0.0f, 0.0f, 1.0f, 0.5f,  // 2: Синий
        1.0f, 1.0f, 0.0f, 0.5f,  // 3: Желтый
        1.0f, 0.0f, 1.0f, 0.5f,  // 4: Маджента
        0.0f, 1.0f, 1.0f, 0.5f,  // 5: Циан
        1.0f, 0.5f, 0.0f, 0.5f,  // 6: Оранжевый
        0.5f, 0.0f, 0.5f, 0.5f   // 7: Фиолетовый
    )
